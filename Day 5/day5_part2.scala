            ...
            while (i < numbers.size) {
                ...
                op match {
                    ...
                    case 4 =>
                        ...
                        i += 2
                    case 5 => 
                        i = if (numbers(getNumber(numbers, i + 1, c)) != 0) numbers(getNumber(numbers, i + 2, b)) else i + 3
                    case 6 =>
                       i = if (numbers(getNumber(numbers, i + 1, c)) == 0) numbers(getNumber(numbers, i + 2, b)) else i + 3
                    case 7 =>
                        numbers(getNumber(numbers, i + 3, a)) = if (numbers(getNumber(numbers, i + 1, c)) < numbers(getNumber(numbers, i + 2, b))) 1 else 0
                        i += 4
                    case 8 =>
                        numbers(getNumber(numbers, i + 3, a)) = if (numbers(getNumber(numbers, i + 1, c)) == numbers(getNumber(numbers, i + 2, b))) 1 else 0
                        i += 4
